...
class EvidenceSelector:
    ...
    def _check_skill_synonyms(self, entities: Dict[str, Any], topic: str) -> Optional[SelectedEvidence]:
        ...
        synonym_maps = {
            "api integration": [".net web api", "express", "fastapi", "rest api", "graphql", "web api", "api"],
            "api development": [".net web api", "express", "fastapi", "rest api", "web api", "api"],
            "api": [".net web api", "express", "fastapi", "rest api", "graphql", "web api"],
